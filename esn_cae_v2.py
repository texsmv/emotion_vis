...
#         self.hidden1 = nn.Linear(n_time * 4, embedding_size)
#         self.hidden2 =  nn.Linear(embedding_size, n_time * 8)


#         self.decoder = nn.Sequential(
#             nn.Conv1d(4, n_dim, 3, padding=1),
#             nn.ReLU(inplace=True),
#             nn.Conv1d(n_dim, n_dim, 3, padding=1),
#             nn.Sigmoid(),
...
class EsnAe2:
    ...
    def train(self,
        ...
        self.ae = ConvAutoencoder(T, H.shape[2], V, self.embedding_size).to(self.device)
        ...
        tensorDataset = TensorDataset(H_tensor, X_tensor)
