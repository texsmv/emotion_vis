...
class PFlutterSlider extends StatefulWidget {
  final Key key;
  final Axis axis;
  ...
  PFlutterSlider(
      ...
      : assert(touchSize == null ||
            (touchSize != null && (touchSize >= 0 && touchSize <= 50))),
        assert(values != null),
        assert(step != null),
...
class _FlutterSliderState extends State<PFlutterSlider>
  ...
  @override
  void didUpdateWidget(PFlutterSlider oldWidget) {
    __isInitCall = false;
